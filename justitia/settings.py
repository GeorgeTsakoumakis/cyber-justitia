"""
Django settings for justitia project.
...
vm_ip_string = os.getenv("VM_IP")
if vm_ip_string is None:
    vm_ip_string = "0.0.0.0"
...
MIDDLEWARE = [
    ...
    "justitia.middleware.LoginAttemptLoggingMiddleware",
    "justitia.middleware.AdminPageLoadLoggingMiddleware",
